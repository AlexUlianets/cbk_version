...
<div>
	...
	<div class="wrapper">
				...
				<div class="tomorrow-item">
					...
					<div class="tmr-main-info">
						<div class="tomorrow-date">
							${dynamicTableData[0][1].dayOfMonth} ${dynamicTableData[0][1].monthOfYear}, ${dynamicTableData[0][1].year}, ${dynamicTableData[0][1].dayOfWeek} (${content.today.toUpperCase()})
						</div>
		...
		<aside class="sidebar top35px">
			...
			<!-- NEW -->
			<img src="https://placehold.it/300x600" alt="alt" class="mob-hide"></img>
